...
|                    | triangle access and | decompress venous   |
|     vicular\*\*    | debulking and       | compression or      |
...
|                    |                     | brachial plexus.    |
|                    | Allows for excision |                     |
|                    | of subclavius       | Difficult to access |
|                    | muscle and          | most posterior      |
|                    | costoclavicular     | aspect of rib       |
|                    | ligament            |                     |
|                    |                     | Cosmetically less   |
|                    |                     | appealing           |
+--------------------+---------------------+---------------------+
| **Paracla          | Useful if mixed     | Requires two        |
| vicular**          | etiology TOS to     | incisions one above |
