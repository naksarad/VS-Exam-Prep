...
Authors: *Adam Johnson, MD, MPH; Nicole Rich, MD, MPH; Kevin Kniery, MD,
MPH*
...
-   \< 4.5 hours from onset of symptoms - medical thrombolysis with tPA
    ...
    -   BP management post stroke **with thrombolysis** includes
        treatment of BP to \<185/110 prior to administration of
        thrombolysis, then keeo \<180/105 for 24hrs post administration.

-   \<6 hours from onset of symptoms - catheter directed therapy

-   After 6 hours, there is limited benefit to thrombolytic therapy.

    -   BP management post stroke **without thrombosis** includes an
        initial period of permissive hypertension, treat only if
        \>220/120. Slowly lower BP to target of 140/90 over 7-14d -
        particularly important to go slow in patients with intra- or
        extra-cranial large vessel stenosis.

        -   Contraindications to permissive hypertension include active
            CAD, heart failure, aortic dissection, hypertensive
            encephalopathy.
...
-   Ipsilateral restenosis
    ...
    -   Risk factors for restenosis include
        hyperlipidemia[@lamuraglia2005], female gender, primary closure
        without patch, younger age, and certain plaque
        characteristics-abundance of smooth muscle, absence of
        macrophages/lymphocytes, and lipid core \<10%.[@hellings2008;
        @pauletto2000]
